...
1) 애플리케이션을 시작하거나 종료할 때 작업을 수행할 옵저버를 만들라.
...
2) DataLoaderListener 옵저버를 App 객체에 등록한 후 실행되는 걸 확인하라.
...
4) App 클래스가 옵저버의 결과물을 사용할 수 있게 하라!
...
6) DataLoaderListener에서 준비한 List 객체를 Command에게 전달하라.
